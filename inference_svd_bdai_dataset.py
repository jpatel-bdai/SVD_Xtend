...
class DummyDataset(Dataset):
    def __init__(self, num_samples=336, width=1024, height=576, sample_frames=15):
        """
        Args:
        ...
        self.rtx_root_dir = '/storage/nfs/jpatel/bridge_data_bdai_mix_04_07_2024/bridge_data_bdai_mix_numpy/bdai'
